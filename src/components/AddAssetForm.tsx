...
export const AddAssetForm = ({ onClose }) => {
  ...
  if (submitted) {
    return (
      <Result
        ...
        subTitle={`Added ${assetRef.current.amount} of ${coin.name} by prcie ${assetRef.current.price}}`}
        extra={[
  ...
  return (
    ...
    >
      ...
      >
        <InputNumber onChange={handleAmounChange} style={{ width: '100%' }} />
      </Form.Item>
      ...
      <Form.Item<FieldType> label="Total" name="total">
        <InputNumber disabled placeholder="Enter coin amount" style={{ width: '100%' }} />
      </Form.Item>
